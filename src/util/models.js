...
const models = [
    new Model("reading", "Reading Comprehension", "Extract and/or generate answers given the source document or passage.", <SearchLocate size={32}/>, "https://huggingface.co/ibm/tydiqa-primary-task-xlm-roberta-large", ["Multilingual", "Diverse Contexts"], "#demos"),
